...
dfn_dir = 'results\DFN\';
if CRate < 0
    dfn_file = "dfn_" + string(CRate) + "C_" + string(t_amb) + "deg_" + string(init_SOC) + "SOC.mat";
else
...
%%
if CRate < 0
    save("results\SPMe\spme_" + string(CRate) + "C_" + string(t_amb) + "deg_" + string(init_SOC) + "SOC.mat", ...
        'spme');
else
